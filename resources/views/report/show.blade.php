                      ...
                      <div class="">
                        ...
                        <div class="row">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                              <div class="x_title">
                                <h2>Report<small>Journey report</small></h2>
                                <ul class="nav navbar-right panel_toolbox">
                                  <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                  </li>
                                  <li class="dropdown">
                              ...
                              <div class="x_content">
                                <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                                  <div class="profile_img">
                                    <div id="crop-avatar">
                                      <!-- Current avatar -->
                                      <img class="img-responsive avatar-view img-thumbnail" src="https://res.cloudinary.com/softwareassurance/{{ $report_journeys->journey_image_attachment }}" alt="Avatar" title="Change the avatar" width="200" />
                                    </div>
                                  </div>
                                  ...
                                  <ul class="list-unstyled user_data">
                                    ...
                                    <li>
                                      <h2 class="card-title"><i class="fa fa-inbox icon"></i>&nbsp;&nbsp;&nbsp;Message : {{ $report_journeys->message }}</p>
                                    </li>
                                    <li>
                                      <h2 class="card-title"><i class="fa fa-envelope"></i>&nbsp;&nbsp;&nbsp;Email : {{ $report_journeys->email_id }}</h2>
                                    </li>
                                    <li>
                                      <h2 class="card-text"><i class="fa fa-user icon"></i>&nbsp;&nbsp;&nbsp;App User Name : {{ $report_journeys->app_user_name }}</h2>
                                    </li>
                                    <li>
                                      <h2 class="card-text"><i class="fa fa-image"></i>&nbsp;&nbsp;&nbsp;Journey Image attachment : {{ $report_journeys->journey_image_attachment }}</h2>
                                    </li>
                                    <li>
                                      <h2 class="card-text"><i class='fa fa-map-marker'></i></i>&nbsp;&nbsp;&nbsp;Start Location : {{ $report_journeys->start_location }}</h2>
                                    </li>
                                    <li>
